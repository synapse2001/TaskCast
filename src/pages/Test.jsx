    ...
    return (
      <html>
        ...
        <div className="taskinput" id="form">
                    ...
                    <input onChange={e => setTask(e.target.value)} class="todo-input" value = {task} type="text" placeholder="Add a task."></input>
                    <button onClick={()=> addToDo(task)} class="todo-btn">I Got This!</button>
